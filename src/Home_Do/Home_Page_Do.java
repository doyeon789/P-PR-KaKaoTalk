...
import After_Login_Do.TalkPage_Me.TalkPage_Me;
import After_Login_Do.TalkPage_Sim.TalkPage_Sim;

public class Home_Page_Do {
    ...
    private static void Friends_Page(JPanel Friends_Panel){
        ...
        ImageIcon BackgroundI = new ImageIcon("image/After_Login_img/Do/Home/Home.PNG");
    ...
    private static void Chatting_Page(JPanel Chatting_Panel){
        ...
        Background.setOpaque(false);
        Background.setBounds(0, 0, 398, 639);
        ImageIcon BackgroundI = new ImageIcon("image/After_Login_img/Do/Home/Home_F.PNG");
        Image Background_img = BackgroundI.getImage();
        Image Background_logo = Background_img.getScaledInstance(398, 639, Image.SCALE_SMOOTH);
        Background.setIcon(new ImageIcon(Background_logo));
    ...
    public static void My_Profile_Frame() {
        ...
        ImageIcon MyProfile_BI = new ImageIcon("image/After_Login_img/Do/Home/MyProfile/MyProfile.png");
