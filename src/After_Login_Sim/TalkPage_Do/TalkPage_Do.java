...
import static Home_Sim.Home_Page_Sim.isTalk_Do_Open;
import static After_Login_Sim.TalkPage_Do.Chat_TalkDo.chat_cnt;


public class TalkPage_Do {
    ...
    public static String MessageFromDo;
    ...
    public static void TalkPage() throws IOException {
        ...
        Thread chatting = new Thread(TalkPage_Do::Chatting);
        chatting.start();
    ...
    private static void Init_Workig(JPanel Talk_panel_me){
        ...
        X_button_Box.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent e) {
                X_button.setVisible(false);
                isTalk_Do_Open = false;
                Home_Page_Sim.setTalk_myself_Open(false);
    ...
    private static void send() {
        ...
        Chat_TalkDo.Chat(messageText, Talk_panel_me, formattedTime);
