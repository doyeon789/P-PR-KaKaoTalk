...
import static Home_Sim.Home_Page_Sim.isTalk_myself_Open;
import static After_Login_Sim.TalkPage_Me.Chat_Talkmyself.chat_cnt;
...
public class TalkPage_Me {
    ...
    private static void Init_Workig(JPanel Talk_panel_me){
        ...
        ImageIcon Talk_B_meI = new ImageIcon("image/After_Login_img/Sim/TalkPage/TalkPage_Me.png");
