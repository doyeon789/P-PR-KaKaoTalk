...
import static After_Login_Do.TalkPage_Me.Chat_Talkmyself.chat_cnt;
import static Home_Do.Home_Page_Do.isTalk_myself_Open;
...
public class TalkPage_Me {
    ...
    public static void TalkPage(){
        ...
        ImageIcon sendingI = new ImageIcon("image/After_Login_img/Do/TalkPage/send.png");
    ...
    private static void Init_Workig(JPanel Talk_panel_me){
        ...
        ImageIcon Talk_B_meI = new ImageIcon("image/After_Login_img/Do/TalkPage/After_Login.TalkPage_Me.png");
